...
const SubscribeButton = styled.button`
  ...
  &:hover {
    background-color: ${props => props.theme.colors.mtnYellow}e0;
  }
`;
      ...
      <Container>
        <GridContainer>
          ...
          <div>
            ...
            <LinkList>
              <ContactItem>
                <ContactIcon fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <Description>Subscribe to our newsletter for the latest updates and winners.</Description>
            <NewsletterForm>
              <EmailInput 
                type="email" 
